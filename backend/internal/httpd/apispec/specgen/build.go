...
var schemaNames = map[string]string{ //nolint:gosec // Public OpenAPI type names include reset-credit contracts; no credential value is stored here.
	...
	"ControllersTerminalModelParametersResponse":          "TerminalModelParametersResponse",
	...
	"PortsModelServiceTier":                       "ModelServiceTier",
...
func sessionOperations() []operation {
	return []operation{
		...
		{
			method: http.MethodGet, path: "/api/v1/sessions/{sessionId}/terminal-model-parameters", id: "getTerminalModelParameters", tag: "sessions",
			summary:    "Read the terminal's saved native model parameters without changing configuration",
			pathParams: []any{controllers.SessionIDParam{}},
			resps: []respUnit{
				{http.StatusOK, controllers.TerminalModelParametersResponse{}},
				{http.StatusNotFound, envelope.APIError{}},
				{http.StatusConflict, envelope.APIError{}},
				{http.StatusInternalServerError, envelope.APIError{}},
				{http.StatusNotImplemented, envelope.APIError{}},
