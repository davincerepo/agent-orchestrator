...
func agentOperations() []operation {
	return []operation{
		...
		},
		{
			...
			summary: "Get one Codex account switch", pathParams: []any{controllers.CodexAccountSwitchIDParam{}},
			resps: []respUnit{{http.StatusOK, controllers.CodexAccountSwitchResponse{}}, {http.StatusNotFound, envelope.APIError{}}, {http.StatusServiceUnavailable, envelope.APIError{}}},
		},
		{
			...
			summary: "Retry incomplete credential recovery for one Codex account switch", pathParams: []any{controllers.CodexAccountSwitchIDParam{}},
